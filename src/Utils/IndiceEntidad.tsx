...
export default function IndiceEntidad<T>(props: inidceEntidadProps<T>){
    ...
    useEffect(() => {
        //axios.get(`${urlGeneros}?Pagina=${pagina}&RecordPorPagina=${recordsPorPagina}`)
        cargarDatos();
    }, [pagina, recordsPorPagina])

    function cargarDatos() {
        axios.get(props.url,{
            params: {Pagina: pagina, RecordPorPagina: recordsPorPagina}
        })
    ...
    return (
        <>
            ...
            <div className="form-group" style={{width: '150px'}}>
                ...
                <select defaultValue={10} className="form-control" onChange={ e => {
                    setPagina(1);
...
interface inidceEntidadProps<T>{
    url: string;
    urlCrear: string;
